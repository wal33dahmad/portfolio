...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  ...
  return (
    <NumericDigit place={place} value={value} height={height} digitStyle={digitStyle} />
  );
}
...
interface CounterProps {
  ...
  /** When true, counter animates to value. When false, shows 0. If not set, uses internal useInView. */
...
export default function Counter({
  ...
  const shouldAnimate = startAnimation !== undefined ? startAnimation : inView;
